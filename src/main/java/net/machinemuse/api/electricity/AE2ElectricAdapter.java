...
public class AE2ElectricAdapter extends ElectricAdapter {
    ...
    public double drainEnergy(double requested) {
        return ElectricConversions
            .museEnergyFromAE(item.extractAEPower(stack, ElectricConversions.museEnergyToAE(requested)));
    }

    @Override
    public double giveEnergy(double provided) {
        return ElectricConversions
            .museEnergyFromAE(item.injectAEPower(stack, ElectricConversions.museEnergyToAE(provided)));
    }
