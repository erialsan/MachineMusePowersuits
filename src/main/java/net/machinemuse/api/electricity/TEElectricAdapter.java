...
public class TEElectricAdapter extends ElectricAdapter {
    ...
    public double drainEnergy(double requested) {
        return ElectricConversions
            .museEnergyFromRF(item.extractEnergy(stack, ElectricConversions.museEnergyToRF(requested), false));
    }

    @Override
    public double giveEnergy(double provided) {
        return ElectricConversions
            .museEnergyFromRF(item.receiveEnergy(stack, ElectricConversions.museEnergyToRF(provided), false));
    }
}
