...
public class SoundDictionary {
    ...
    public static String[] soundFiles = { SOUND_RESOURCE_LOCATION + "Glider.ogg",
        SOUND_RESOURCE_LOCATION + "GUIInstall.ogg", SOUND_RESOURCE_LOCATION + "MMMPSboop.wav",
        SOUND_RESOURCE_LOCATION + "JetBoots.ogg", SOUND_RESOURCE_LOCATION + "Jetpack.ogg",
