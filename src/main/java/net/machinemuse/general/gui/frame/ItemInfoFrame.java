...
public class ItemInfoFrame extends ScrollableFrame {
    ...
    public ItemInfoFrame(EntityPlayer player, MusePoint2D topleft, MusePoint2D bottomright, Colour borderColour,
        Colour insideColour, ItemSelectionFrame target) {
    ...
    public void update(double mousex, double mousey) {
        ...
        if (selected != null) {
            IModularItem item = MuseItemUtils.getAsModular(
                selected.getItem()
                    .getItem());
