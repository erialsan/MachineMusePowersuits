...
public class DetailedSummaryFrame extends ScrollableFrame {
    ...
    public DetailedSummaryFrame(EntityPlayer player, MusePoint2D topleft, MusePoint2D bottomright, Colour borderColour,
        Colour insideColour) {
    ...
    public void draw() {
        if (player != null) {
            ...
            MuseRenderer.drawCenteredString(
                StatCollector.translateToLocal("gui.equippedTotals"),
            ...
            formattedValue = MuseStringUtils.wrapFormatTags(
                MuseStringUtils.formatNumberFromUnits(weight, PowerModule.getUnit(MuseCommonStrings.WEIGHT)),
                weight > Config.getWeightCapacity() ? MuseStringUtils.FormatCodes.Red
                    : MuseStringUtils.FormatCodes.BrightGreen);
