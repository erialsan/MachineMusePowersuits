...
public class PartManipContainer extends ScrollableFrame {
    ...
    public PartManipContainer(ItemSelectionFrame itemSelect, ColourPickerFrame colourSelect, MusePoint2D topleft,
        MusePoint2D bottomright, Colour borderColour, Colour insideColour) {
    ...
    public ItemStack getItem() {
        return (itemSelect.getSelectedItem() != null) ? itemSelect.getSelectedItem()
            .getItem() : null;
    }
    ...
    public int getColour() {
        if (getItem() == null) return Colour.WHITE.getInt();
        ...
        else return Colour.WHITE.getInt();
    }
    ...
    public List<PartManipSubFrame> getModelframes() {
        ...
        Collection<ModelSpec> specCollection = ModelRegistry.getInstance()
            .apply()
            .values();
