...
public class GuiTinkerTable extends MuseGui {
    ...
    public void initGui() {
        ...
        DetailedSummaryFrame statsFrame = new DetailedSummaryFrame(
            player,
    ...
    public void drawScreen(int x, int y, float z) {
        ...
        if (itemSelectFrame.hasNoItems()) {
            ...
            MuseRenderer
                .drawCenteredString(StatCollector.translateToLocal("gui.noModulesFound.line1"), centerx, centery - 5);
            MuseRenderer
                .drawCenteredString(StatCollector.translateToLocal("gui.noModulesFound.line2"), centerx, centery + 5);
        }
    }
}
