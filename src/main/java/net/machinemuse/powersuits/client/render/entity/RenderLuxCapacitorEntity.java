...
public class RenderLuxCapacitorEntity extends MuseRender {
    ...
    public static WavefrontObject getLightModel() {
        if (lightmodel == null) {
            lightmodel = (WavefrontObject) AdvancedModelLoader
                .loadModel(new ResourceLocation(Config.RESOURCE_PREFIX + "models/lightCore.obj"));
        }
        return lightmodel;
    }
    ...
    public static WavefrontObject getFrameModel() {
        if (framemodel == null) {
            framemodel = (WavefrontObject) AdvancedModelLoader
                .loadModel(new ResourceLocation(Config.RESOURCE_PREFIX + "models/lightBase.obj"));
        }
        return framemodel;
    }

    @Override
    public void doRender(Entity undifferentiatedentity, double x, double y, double z, float yaw,
