...
//
// @Override
// public boolean onItemUse(ItemStack itemStack, EntityPlayer player, World world, int x, int y, int z, int side, float
...
// sideIndex, float hitX, float hitY, float hitZ) {
...
////
//// def onItemUse(itemStack: ItemStack, player: EntityPlayer, world: World, x: Int, y: Int, z: Int, side: Int, hitX:
// Float, hitY: Float, hitZ: Float): Boolean = {
//// false
//// }
////
//// def onItemUseFirst(itemStack: ItemStack, player: EntityPlayer, world: World, x: Int, y: Int, z: Int, sideIndex:
// Int, hitX: Float, hitY: Float, hitZ: Float): Boolean = {
//
//// }
////
