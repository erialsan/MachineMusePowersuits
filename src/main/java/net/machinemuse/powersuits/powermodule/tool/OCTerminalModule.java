...
// player.openGui( Loader.instance().getIndexedModList().get("OpenComputers").getMod() , GuiType.Terminal().id(), world,
// 0, 0, 0);
// }
// player.swingItem();
// }
...
//
// @Override
// public void onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float hitX,
...
//
// @Override
// public boolean onItemUseFirst(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float
