...
public class StolenWrenchCode {
    ...
    public static boolean onItemUseFirst(ItemStack stack, EntityPlayer player, World world, int x, int y, int z,
        ...
        if (ModCompatibility.isRFAPILoaded() && ServerHelper.isServerWorld(world)
            && player.isSneaking()
