...
public abstract class PowerModuleBase implements ILocalizeableModule {
    ...
    public PowerModuleBase addTradeoffProperty(String tradeoffName, String propertyName, double multiplier) {
        double propFromConfig = Config.getConfig()
            .get("Properties", getDataName() + '.' + propertyName + '.' + tradeoffName + ".multiplier", multiplier)
    ...
    public PowerModuleBase addSimpleTradeoff(IPowerModule module, String tradeoffName, String firstPropertyName,
        String firstUnits, double firstPropertyBase, double firstPropertyMultiplier, String secondPropertyName,
        String secondUnits, double secondPropertyBase, double secondPropertyMultiplier) {
    ...
    public PowerModuleBase addBaseProperty(String propertyName, double baseVal) {
        double propFromConfig = Config.getConfig()
            .get("Properties", getDataName() + '.' + propertyName + ".base", baseVal)
            .getDouble(baseVal);
    ...
    public boolean equals(PowerModule other) {
        return other != null && other.getDataName()
            .equals(this.getDataName());
    }
