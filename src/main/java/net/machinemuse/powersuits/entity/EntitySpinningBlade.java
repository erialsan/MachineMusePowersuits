...
public class EntitySpinningBlade extends EntityThrowable {
    ...
    protected void onImpact(MovingObjectPosition hitMOP) {
                ...
                if (target.isShearable(this.shootingItem, world, hitMOP.blockX, hitMOP.blockY, hitMOP.blockZ)
                    ...
                    if (this.shootingEntity instanceof EntityPlayer) {
                        ((EntityPlayer) shootingEntity)
                            .addStat(StatList.mineBlockStatArray[Block.getIdFromBlock(block)], 1);
                    }
                }
        ...
        } else if (hitMOP.typeOfHit == MovingObjectPosition.MovingObjectType.ENTITY
            && hitMOP.entityHit != this.shootingEntity) {
