...
public class MusePacketTweakRequest extends MusePacket {
    ...
    public MusePacketTweakRequest(EntityPlayer player, int itemSlot, String moduleName, String tweakName,
        double tweakValue) {
        this.player = player;
    ...
    public static MusePacketTweakRequestPackager getPackagerInstance() {
        if (PACKAGERINSTANCE == null) PACKAGERINSTANCE = new MusePacketTweakRequestPackager();
